  ...
  return (
    <div className="h-[calc(100vh-96px)] overflow-hidden relative">
      ...
      >
        ...
        >
          {getJsonValue("M2S entreprise for")}
        </motion.h1>
        <motion.h1
          variants={textVariants}
          className="text-4xl md:text-6xl 2xl:text-8xl capitalize"
        >
          {getJsonValue("all software related solutions")}
        </motion.h1>
        <motion.div
          variants={textVariants}
        ...
        >
          <Link href={"#portfolio"}>
            ...
            >
              {getJsonValue("See the Latest Works")}
            </motion.button>
          </Link>
          <Link href={"#contact"}>
            <motion.button
      ...
      >
        {getJsonValue("Programmer, Developer, Problem Solver")}
      </motion.div>
