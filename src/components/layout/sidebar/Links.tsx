  ...
  return (
    ...
    >
      ...
      <motion.div style={{ display: "flex", justifyContent: "space-around", width: "100%" }}>
        <img
          onClick={() => { changeCurrentLanguage("ar"); }}
          src="assets/323301.png"
          style={{ cursor: "pointer", width: 50, height: 50, opacity: lang === "ar" ? 1 : 0.5 }}
        />
        <img
          onClick={() => { changeCurrentLanguage("en"); }}
          src="assets/4628635.png"
          style={{ cursor: "pointer", width: 50, height: 50, opacity: lang === "en" ? 1 : 0.5 }}
        />
        <img
          onClick={() => { changeCurrentLanguage("fr"); }}
          src="assets/197560.png"
          style={{ cursor: "pointer", width: 50, height: 50, opacity: lang === "fr" ? 1 : 0.5 }}
        />
      </motion.div>
